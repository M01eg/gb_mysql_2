DROP DATABASE IF EXISTS coursework_imdb;
CREATE DATABASE coursework_imdb;
USE coursework_imdb;
...
-- Жанры фильмов (таблица многие-к-многим)
...
-- Фильмографии актеров (таблица многие-к-многим)
...
-- Далее 3 таблицы многие-к-многим, описывающие
-- предпочтения пользователей ресурса
