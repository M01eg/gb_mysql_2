-- ¬ыборка: пользователи, про¤вл¤вшие
...
-- ¬ыборка: рекомендации фильмов дл¤ пользовател¤ (с user_id == 10) по его вкусу
-- ѕоиск пользователей у которых такой же любимый режиссер,
